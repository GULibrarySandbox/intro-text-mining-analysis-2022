...
Explore how these fabrics are related to each other at:[http://dh.library.yale.edu/projects/vogue/fabricspace/](http://dh.library.yale.edu/projects/vogue/fabricspace/ )

{% include figure.html img="VogueTopicAnalysisVis.PNG" alt="Frequency of topics visualised in a timeline" caption="Frequency of topics visualised in a timeline" width="100%" %}
...
View the other topics identified in Vogue and their frequency across time at: http://dh.library.yale.edu/projects/vogue/topics/

Explore the many computational methods and visualisations available from the *Robots Reading Vogue project* from: 
